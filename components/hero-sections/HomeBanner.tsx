  ...
  return (
    <div className="relative max-w-screen w-full bg-gradient-to-r from-blue-700 to-blue-500 bg-repeat bg-center">
      ...
      <div className="flex lg:flex-row flex-col items-center justify-center gap-10 text-center mt-10">
        ...
        <button className=" bg-[#00C2CC] py-2 rounded text-white font-bold lg:w-[150px] flex justify-center"><span className="text-center px-1">{bannerSection?.applyButton}</span></button>
        </div>
        </div>
        <div className="mt-10 w-full p-2 bg-[#ebf0fa]  rounded shadow-lg lg:w-2/4 py-5 lg:py-10 text-gray-900">
          ...
          <form className="mt-5 space-y-4 lg:mt-10">
            ...
            <button type="submit" className="w-full bg-[#00C2CC] py-2 rounded text-white font-bold lg:w-[300px] xl:w-[400px]">Get A Free Consultation</button>
          </form>
        </div>
      </div>
    </section>
